...
class TestatorType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('dateOfDeathNormalized',      DateType::class,                                        array("required" => true, 'widget' => 'single_text'))
            ->add('dateOfDeathEndNormalized',   DateType::class,                                        array("required" => false, 'widget' => 'single_text'))
