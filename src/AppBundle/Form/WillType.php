...
class WillType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('envelopPhysDescSupport',     TextType::class,                                        array("required" => false))
            ->add('envelopPhysDescHeight',      TextType::class,                                        array("required" => false))
            ->add('envelopPhysDescWidth',       TextType::class,                                        array("required" => false))
            ->add('envelopPhysDescHand',        TextType::class,                                        array("required" => false))
